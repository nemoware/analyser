...
from analyser.transaction_values import extract_sum, find_value_spans, ValueSpansFinder
...
data = [
  ...
  (0, 80000, 'RUB', False, 'Стоимость оборудования 80000,00 (восемьдесят тысяч рублей рублей 00 копеек) рублей,'),  # TODO
