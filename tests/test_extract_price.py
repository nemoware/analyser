...
data = [
  ...
  (0, 51666666.92, 'RUB', '2.2 Общая стоимость Услуг составляет шестьдесят два миллиона (62000000) рублей ноль (30) копеек, включая НДС (20%): '
  ...
  (0, 45796632.20, 'RUB', '3.1. Договорная цена в соответствии с Протоколом согласования договорной цены (Приложение №1 к Договору) составляет: ' 
