...
from tests.test_document import FakeEmbedder
...
class CoumpoundFuzzyPatternTestCase(unittest.TestCase):
    ...
    def test_embedder(self):
        ...
        PF = AbstractPatternFactory(FakeEmbedder(point1, TOKENIZER_DEFAULT))
    ...
    def test_coumpound_find(self):
        ...
        embedder = FakeEmbedder(point2, TOKENIZER_DEFAULT)
